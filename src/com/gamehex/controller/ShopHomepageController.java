 ...
 * @author Dr.Green
 */
public class ShopHomepageController implements Initializable {
...
FXMLLoader fxmlLoader = new FXMLLoader();
        Parent parent = FXMLLoader.load(getClass().getResource("/com/gamehex/view/LoadProducts.fxml"));
                Scene scene = new Scene(parent);
                Stage stage = new Stage();
                stage.setTitle("Home");
                //stage.getIcons().add(new Image("com/gamehex/assets/NotePad.png"));
     ...
     @FXML
    void OnCartClickedfront(MouseEvent event) throws IOException {
FXMLLoader fxmlLoader = new FXMLLoader();
        Parent parent = FXMLLoader.load(getClass().getResource("/com/gamehex/view/CartView.fxml"));
                Scene scene = new Scene(parent);
                Stage stage = new Stage();
                stage.setTitle("Home");
                //stage.getIcons().add(new Image("com/gamehex/assets/NotePad.png"));
